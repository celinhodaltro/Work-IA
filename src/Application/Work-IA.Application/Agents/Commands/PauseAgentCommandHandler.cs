...
public sealed class PauseAgentCommandHandler : IRequestHandler<PauseAgentCommand>
{
    private readonly IAgentRepository _repository;
    private readonly AgentRegistry _agentRegistry;

    public PauseAgentCommandHandler(IAgentRepository repository, AgentRegistry agentRegistry)
    {
        _repository = repository;
        _agentRegistry = agentRegistry;
    }

    public async Task Handle(PauseAgentCommand request, CancellationToken cancellationToken)
    {
        ...
        if (runtimeAgent is not null)
            await runtimeAgent.PauseAsync(cancellationToken);
    }
}
